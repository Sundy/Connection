...
test('profile page shows profile form and removes parent child creation form', () => {
  ...
  assert.match(markup, /canvas-id="inviteQrCanvas"/)
  assert.match(markup, /bindtap="scanJoinCode"/)
  assert.match(markup, /扫码加入家庭/)
  assert.match(markup, /更换家庭/)
  assert.match(markup, /扫码更换家庭/)
...
test('profile groups expose details on demand', () => {
  ...
  assert.match(controller, /buildJoinPayload/)
  assert.match(controller, /parseInviteCode/)
  assert.match(controller, /drawQrToCanvas/)
  assert.match(controller, /wx\.scanCode/)
  assert.match(controller, /confirmJoinWithInviteCode/)
  assert.match(controller, /wx\.showModal/)
  assert.match(controller, /确认更换/)
